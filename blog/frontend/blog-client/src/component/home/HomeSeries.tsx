...
export default function HomeSeries() {
    const seriesState: {
        ...
        hasError: boolean,
        error: any,
        pageResult: PageResult<Series>
    } = useSelector((state: any) => {
        return state.fetchSeries
    })
    ...
    return (
        <>
            <>
                ...
                {seriesState?.pageResult?.list?.map((post, idx) => (
                ...
                <div className="d-flex justify-content-center">
                    {seriesState.pageResult?.list && <PagingComponent
                        currentPage={seriesState.pageResult.currentPage}
                        totalPage={seriesState.pageResult.totalPage}
                    />}
                </div>
            </>
        </>
