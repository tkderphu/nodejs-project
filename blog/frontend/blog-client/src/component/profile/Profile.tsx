                ...
                <div className="row">
                    <div className="col-lg-8 col-md-7">
                        ...
                        <ul className="nav nav-tabs">
                            ...
                            <li className="nav-item"><a className="nav-link" href="#">Câu hỏi</a></li>
                            <li className="nav-item"><a className="nav-link" href="#">Câu trả lời</a></li>
                            ...
                            <li className="nav-item"><a className="nav-link" href="#">Reputations</a></li>
                    ...
                    <div className="col-lg-4 col-md-5">
                        <div className="stats-box">
                            ...
                            <div className="stats-item"><span>Reputations</span> <strong>0</strong></div>
                            ...
                            <div className="stats-item"><span>Tổng số câu hỏi</span> <strong>0</strong></div>
                            <div className="stats-item"><span>Tổng số câu trả lời</span> <strong>0</strong></div>
                        </div>
                    </div>
                </div>
            </div>
